...
// Useful mathematical functions: ramp, and cubic function with its derivatives
inline double ramp(int time, int start) {return std::max(0, time - start);}

inline double cubic(double t) {return -2*t*t*t + 3*t*t;}
